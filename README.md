# genpark-superapp-multivertical-turbo-delivery-routing-skill
...
> **GenPark AI Agent Skill** -- Superapp multi-vertical 10-minute turbo delivery routing engine (Rappi style)
